      ...
      <div class="py-24 sm:py-32 lg:pb-40">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto max-w-2xl text-center">
            <h1 class="text-5xl font-semibold tracking-tight text-balance text-white sm:text-7xl">Acore delivers a unified admin dashboard and client portal</h1>
            <p class="mt-8 text-lg font-medium text-pretty text-gray-400 sm:text-xl/8">all running atop cutting-edge infrastructure built with the latest, highest-performance tech. Enjoy real-time analytics, seamless CI/CD via GitHub Actions, Docker-powered deployments, and a rock-solid security foundation—everything you need to scale your business with confidence.</p>
            <div class="mt-10 flex items-center justify-center gap-x-6">
              <a href="login" class="rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-indigo-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400">Get started</a>
